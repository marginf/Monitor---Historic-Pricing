...
WebUI.selectOptionByValue(findTestObject('Historic Pricing/Category'),'16a4ee1d-42cb-44ca-84be-9939b29f00f8', false) // E_Intermediate (Mazda 6)
WebUI.click(findTestObject('Historic Pricing/Category'))
...
WebUI.clickOffset(findTestObject('Historic Pricing/Tooltip'), 173, 825)
WebUI.getText(findTestObject('Historic Pricing/Tooltip'))
WebUI.verifyTextPresent('Daily Rate',false)
WebUI.clickOffset(findTestObject('Historic Pricing/Tooltip'), 173, 325)
WebUI.getText(findTestObject('Historic Pricing/Tooltip'))
WebUI.verifyTextPresent('Daily Rate',false)
WebUI.clickOffset(findTestObject('Historic Pricing/Tooltip'), 314, 63)
WebUI.getText(findTestObject('Historic Pricing/Tooltip'))
WebUI.verifyTextPresent('Daily Rate',false)
...
WebUI.focus(findTestObject('Historic Pricing/Display Records'))
