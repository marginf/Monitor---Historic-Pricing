...
WebUI.selectOptionByValue(findTestObject('Historic Pricing/Market'),Australia, false)
WebUI.click(findTestObject('Historic Pricing/Market'))
...
WebUI.selectOptionByLabel(findTestObject('Historic Pricing/Pickup Location'),'Melbourne Airport', false) 
WebUI.click(findTestObject('Historic Pricing/Pickup Location'))

// Select Dropoff Location
WebUI.click(findTestObject('Historic Pricing/Dropoff Location'))
WebUI.selectOptionByLabel(findTestObject('Historic Pricing/Dropoff Location'),'Melbourne Airport', false)
WebUI.click(findTestObject('Historic Pricing/Dropoff Location'))

// Select Category Type
WebUI.click(findTestObject('Historic Pricing/Category'))
WebUI.selectOptionByValue(findTestObject('Historic Pricing/Category'),'c310e47d-f22e-4871-acfb-f747f8821412', false) // S_Standard (Toyota Corolla Sedan)
WebUI.click(findTestObject('Historic Pricing/Category'))
...
WebUI.clickOffset(findTestObject('Historic Pricing/Tooltip'), 1531, 400)
WebUI.getText(findTestObject('Historic Pricing/Tooltip'))
WebUI.verifyTextPresent('Daily Rate',false)
WebUI.clickOffset(findTestObject('Historic Pricing/Tooltip'), 905, 1287)
WebUI.getText(findTestObject('Historic Pricing/Tooltip'))
WebUI.verifyTextPresent('Daily Rate',false)
